...
public:
    int trailingZeroes(int N)
    {
       ...
       /* The code is calculating the number of trailing zeroes in the factorial of N. */
        while(N>=5)
        {
            count+=N/5;  // because 2*5 = 10 for example 100/5 => 20/5 => 4 (becuase 4<5) ==> total zeroes is 24
            N = N/5;
        }
